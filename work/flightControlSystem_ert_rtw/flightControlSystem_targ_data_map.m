    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.DelayOneStep_InitialCondition
                    section.data(2).logicalSrcIdx = 2;
                    section.data(2).dtTransOffset = 1;

                    ;% dexojrsdjj.Switch1_Threshold
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.or2h1n1nyy
                    section.data(1).logicalSrcIdx = 5;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.igohnpg1lt
                    section.data(2).logicalSrcIdx = 6;
                    section.data(2).dtTransOffset = 19200;

                    ;% ntrh2fpvwnc.jp3kdsuiad
                    section.data(3).logicalSrcIdx = 7;
                    section.data(3).dtTransOffset = 38400;

                    ;% ntrh2fpvwnc.adid4uneba
            ...
            section.data(11)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.pxiblaqoqt
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.lejzvzw2zo.LoggedData
                    section.data(1).logicalSrcIdx = 1;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.nynvon0nwx.LoggedData
                    section.data(2).logicalSrcIdx = 2;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.ngrcqjwmud.LoggedData
                    section.data(3).logicalSrcIdx = 3;
                    section.data(3).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.cpmtr3ll1g.LoggedData
                    section.data(4).logicalSrcIdx = 4;
                    section.data(4).dtTransOffset = 3;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.c0qowsso35
                    section.data(1).logicalSrcIdx = 7;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.iyymm3jmo3
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.lsmnpkq1bc.LoggedData
                    section.data(2).logicalSrcIdx = 18;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.fxgka2mnesn.iinqbnytf3.LoggedData
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.pe1slp4ie3
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ksmo45jsfn
                    section.data(1).logicalSrcIdx = 57;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.gpp4czshig
                    section.data(2).logicalSrcIdx = 58;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.kc5xn0ozdk
                    section.data(2).logicalSrcIdx = 60;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.frvmw0hq3z
    ...
    targMap.checksum0 = 757378073;
    targMap.checksum1 = 560707135;
    targMap.checksum2 = 3865839213;
    targMap.checksum3 = 2288520139;
